...
// Printing macros for cluster: Carbon Dioxode Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER)
#define emberAfCarbonDioxideMfgSpecificClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER, __VA_ARGS__)
#define emberAfCarbonDioxideMfgSpecificClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfCarbonDioxideMfgSpecificClusterFlush()
#define emberAfCarbonDioxideMfgSpecificClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER) ) { x; }
#define emberAfCarbonDioxideMfgSpecificClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER, (buffer), (len), (withSpace))
#define emberAfCarbonDioxideMfgSpecificClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER, (buffer))
#else
#define emberAfCarbonDioxideMfgSpecificClusterPrint(...)
#define emberAfCarbonDioxideMfgSpecificClusterPrintln(...)
#define emberAfCarbonDioxideMfgSpecificClusterFlush()
#define emberAfCarbonDioxideMfgSpecificClusterDebugExec(x)
#define emberAfCarbonDioxideMfgSpecificClusterPrintBuffer(buffer, len, withSpace)
#define emberAfCarbonDioxideMfgSpecificClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_CARBON_DIOXIDE_MFG_SPECIFIC_CLUSTER)


// Printing macros for cluster: PM1.0 Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER)
#define emberAfPm10MfgSpecificClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER, __VA_ARGS__)
#define emberAfPm10MfgSpecificClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPm10MfgSpecificClusterFlush()
#define emberAfPm10MfgSpecificClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER) ) { x; }
#define emberAfPm10MfgSpecificClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER, (buffer), (len), (withSpace))
#define emberAfPm10MfgSpecificClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER, (buffer))
#else
#define emberAfPm10MfgSpecificClusterPrint(...)
#define emberAfPm10MfgSpecificClusterPrintln(...)
#define emberAfPm10MfgSpecificClusterFlush()
#define emberAfPm10MfgSpecificClusterDebugExec(x)
#define emberAfPm10MfgSpecificClusterPrintBuffer(buffer, len, withSpace)
#define emberAfPm10MfgSpecificClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PM1_0_MFG_SPECIFIC_CLUSTER)


// Printing macros for cluster: PM10.0 Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER)
#define emberAfPm100MfgSpecificClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER, __VA_ARGS__)
#define emberAfPm100MfgSpecificClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPm100MfgSpecificClusterFlush()
#define emberAfPm100MfgSpecificClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER) ) { x; }
#define emberAfPm100MfgSpecificClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER, (buffer), (len), (withSpace))
#define emberAfPm100MfgSpecificClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER, (buffer))
#else
#define emberAfPm100MfgSpecificClusterPrint(...)
#define emberAfPm100MfgSpecificClusterPrintln(...)
#define emberAfPm100MfgSpecificClusterFlush()
#define emberAfPm100MfgSpecificClusterDebugExec(x)
#define emberAfPm100MfgSpecificClusterPrintBuffer(buffer, len, withSpace)
#define emberAfPm100MfgSpecificClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PM10_0_MFG_SPECIFIC_CLUSTER)


// Printing macros for cluster: PM2.5 Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER)
#define emberAfPm25MfgSpecificClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER, __VA_ARGS__)
#define emberAfPm25MfgSpecificClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPm25MfgSpecificClusterFlush()
#define emberAfPm25MfgSpecificClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER) ) { x; }
#define emberAfPm25MfgSpecificClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER, (buffer), (len), (withSpace))
#define emberAfPm25MfgSpecificClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER, (buffer))
#else
#define emberAfPm25MfgSpecificClusterPrint(...)
#define emberAfPm25MfgSpecificClusterPrintln(...)
#define emberAfPm25MfgSpecificClusterFlush()
#define emberAfPm25MfgSpecificClusterDebugExec(x)
#define emberAfPm25MfgSpecificClusterPrintBuffer(buffer, len, withSpace)
#define emberAfPm25MfgSpecificClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PM2_5_MFG_SPECIFIC_CLUSTER)


// Printing macros for cluster: TVOC Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER)
#define emberAfTvocMfgSpecificClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER, __VA_ARGS__)
#define emberAfTvocMfgSpecificClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfTvocMfgSpecificClusterFlush()
#define emberAfTvocMfgSpecificClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER) ) { x; }
#define emberAfTvocMfgSpecificClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER, (buffer), (len), (withSpace))
#define emberAfTvocMfgSpecificClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER, (buffer))
#else
#define emberAfTvocMfgSpecificClusterPrint(...)
#define emberAfTvocMfgSpecificClusterPrintln(...)
#define emberAfTvocMfgSpecificClusterFlush()
#define emberAfTvocMfgSpecificClusterDebugExec(x)
#define emberAfTvocMfgSpecificClusterPrintBuffer(buffer, len, withSpace)
#define emberAfTvocMfgSpecificClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_TVOC_MFG_SPECIFIC_CLUSTER)

...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/C:/Program%20Files/SimplicityStudio-5/developer/toolchains/gnu_arm/10.2_2020q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print (" ")
    EBL_COMMAND = START_FLAGS + shortPath(r"C:\Program Files\SimplicityStudio-5\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device EFR32MG14P732F256IM48 " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"C:\Program Files\SimplicityStudio-5\developer\adapter_packs\commander\commander.exe").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device EFR32MG14P732F256IM48"
...
if (not "efr32mg14p" or ("efr32mg14p" and not "efr32mg14p".startswith("EM3"))):
    S37()
